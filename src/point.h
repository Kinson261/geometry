...
template <typename T> class Point3D : public Point2D<T>, public boost::addable<Point3D<T>>, public boost::subtractable<Point3D<T>>
{
    protected:
        T z;
...
template <typename T> class Point3D4 : public Point3D<T>
{
    protected:
        T s;
